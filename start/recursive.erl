...
-export([fac/1, tail_fac/1, len/1, tail_len/1, duplicate/2, tail_duplicate/2,
         reverse/1, tail_reverse/1, sublist/2, tail_sublist/2, zip/2,
         lenient_zip/2, tail_zip/2, tail_lenient_zip/2, quicksort/1,
         lc_quicksort/1]).

fac(0) -> 1;
fac(Num) when Num > 0 -> Num * fac(Num-1).

tail_fac(Num) -> tail_fac(Num, 1).
tail_fac(0, Acc) -> Acc;
tail_fac(Num, Acc) when Num > 0 -> tail_fac(Num-1, Num*Acc).
